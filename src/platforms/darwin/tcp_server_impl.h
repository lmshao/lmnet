...
#ifndef LMSHAO_LMNET_DARWIN_TCP_SERVER_IMPL_H
#define LMSHAO_LMNET_DARWIN_TCP_SERVER_IMPL_H
...
private:
    ...
    std::unique_ptr<lmcore::DataBuffer> readBuffer_;
...
#endif // LMSHAO_LMNET_DARWIN_TCP_SERVER_IMPL_H
